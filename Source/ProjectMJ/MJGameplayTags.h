...
namespace MJGameplayTags
{
	...
	PROJECTMJ_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Input_Attack_Normal);
	PROJECTMJ_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Input_Attack_Press);
	...
	/*Attack_Tag*/
	PROJECTMJ_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Attack_Normal_Sword);
	PROJECTMJ_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Attack_Press_Sword);
}
