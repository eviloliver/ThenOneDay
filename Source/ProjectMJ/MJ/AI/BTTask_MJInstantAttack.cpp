...
#include "MJ/AI/BTTask_MJInstantAttack.h"
...
UBTTask_MJInstantAttack::UBTTask_MJInstantAttack()
{
	NodeName = TEXT("InstantAttack");
}

EBTNodeResult::Type UBTTask_MJInstantAttack::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	FGameplayTag SkillTypeTag = FGameplayTag::RequestGameplayTag(FName("Skill.Instant"));
