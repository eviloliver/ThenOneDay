...
FDungeonNode UMJGameInstanceTG::MakeNewNode(uint8 NodeNum, uint8 AssignedMapID, ENodeType NodeType, FVector2D UICoordinate)
{
...
void UMJGameInstanceTG::ConnectNodesByDistance(float MaxDistance, int MaxEdgePerNode)
{
...
void UMJGameInstanceTG::ConnectNodesByMST(float MaxDistance)
{
...
FVector2D UMJGameInstanceTG::GetCubicBezier(float t, const FVector2D Point)
{
	return FVector2D(0,0);
}

FVector2D UMJGameInstanceTG::GetQuadBezier(float t, const FVector2D StartPoint, const FVector2D EndPoint,
